...
export default function TopicCard({ questionData }) {
      ...
      return (
        <Fade duration={500 + index * 0.4} key={index}>
          <div className="col mb-4">
            ...
            >
              <Card
                className={`mb-3  animate__slideInDown hvr-grow ${
                  dark ? "darkCard inprogress-dark-card" : "inprogress-light-card"
                }`}
              >
                <Card.Body>
                  <Row>
                  ...
                  <ProgressBar
                    ...
                    style={{ height: "8px", backgroundColor:"#3b4355" }}
                    now={percentDone}
                  />
                </Card.Body>
              </Card>
      ...
      return (
        <Fade duration={500 + index * 50} key={index}>
          <div className="col mb-4">
            ...
            >
              <Card
                className={`mb-3  hvr-grow ${
                  dark ? "darkCard notstarted-dark-card" : "notstarted-light-card"
                }`}
              >
                <Card.Body>
                  <Row>
                    ...
                    <Col>
                      <h4 className="d-flex justify-content-end" >
                        <button
                          className="float-right start-btn"
                        >
                          Start Now
                        </button>
                      </h4>
  ...
  return (
    <>
      <h3 className="app-heading2 text-center mb-3 mt-4" style={{ fontSize: "22px" }}>
      ...
      <h5 className="text-center mb-4">
        ...
        <p className="percentDone container mt-1 d-flex justify-content-center align-items-center">
          {totalSolved ? (
            <ProgressBar
              animated={
              ...
              style={{ margin: "0.2em 5em", height: "10px", width: '60%', backgroundColor:"#3b4355" }}
            />
          ) : null}
        </p>
      </h5>
